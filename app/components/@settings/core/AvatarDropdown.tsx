...
const BetaLabel = () => (
  <span className="px-1.5 py-0.5 rounded-full bg-orange-/10 dark:bg-orange-/20 text-[10px] font-medium text-orange- dark:text-orange- ml-2">
    BETA
  </span>
);
        ...
        >
          ...
          <DropdownMenu.Item
            className={classNames(
              ...
              'hover:bg-orange- dark:hover:bg-orange-/10',
          ...
          >
            <div className="i-ph:user-circle w-4 h-4 text-gray-400 group-hover:text-orange- dark:group-hover:text-orange- transition-colors" />
            Edit Profile
          </DropdownMenu.Item>
          ...
          >
            <div className="i-ph:gear-six w-4 h-4 text-gray-400 group-hover:text-orange- dark:group-hover:text-orange- transition-colors" />
            Settings
          </DropdownMenu.Item>
          ...
          >
            <div className="i-ph:activity w-4 h-4 text-gray-400 group-hover:text-orange- dark:group-hover:text-orange- transition-colors" />
            Task Manager
            <BetaLabel />
          </DropdownMenu.Item>
          ...
          >
            <div className="i-ph:heartbeat w-4 h-4 text-gray-400 group-hover:text-orange- dark:group-hover:text-orange- transition-colors" />
            Service Status
            <BetaLabel />
          </DropdownMenu.Item>
        </DropdownMenu.Content>
